...
public abstract class Hilt_MonitoringFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MonitoringFragment() {
    super();
  }

  Hilt_MonitoringFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MonitoringFragment_GeneratedInjector) this.generatedComponent()).injectMonitoringFragment(UnsafeCasts.<MonitoringFragment>unsafeCast(this));
    }
  }
