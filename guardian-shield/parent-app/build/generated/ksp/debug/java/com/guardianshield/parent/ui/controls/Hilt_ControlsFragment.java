...
public abstract class Hilt_ControlsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ControlsFragment() {
    super();
  }

  Hilt_ControlsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ControlsFragment_GeneratedInjector) this.generatedComponent()).injectControlsFragment(UnsafeCasts.<ControlsFragment>unsafeCast(this));
    }
  }
