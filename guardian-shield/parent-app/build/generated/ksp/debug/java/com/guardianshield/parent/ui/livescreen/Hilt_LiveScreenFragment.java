...
public abstract class Hilt_LiveScreenFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LiveScreenFragment() {
    super();
  }

  Hilt_LiveScreenFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LiveScreenFragment_GeneratedInjector) this.generatedComponent()).injectLiveScreenFragment(UnsafeCasts.<LiveScreenFragment>unsafeCast(this));
    }
  }
